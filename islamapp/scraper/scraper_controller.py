...
class ScraperCotroller(Process):
    def __init__(self, status_logger, mission_logger, run_period=1, run_local=True, local_driver_limit=3):
        super().__init__()
    ...
    def routine_job(self):
        if not self.run_local:
            ...
            while (not self.tasks.empty() ) and (idle_node_counts > 0):
                ...
                mission_runner = MissionRunner(task, self.mission_logger, self.run_local)
