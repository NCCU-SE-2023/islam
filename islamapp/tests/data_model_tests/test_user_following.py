...
class TestUserFollowing(unittest.TestCase):
    ...
    def test_get_latest_user_following_by_ig_id(self):
        get_latest_user_following_by_ig_id = (
            UserFollowing.get_latest_user_following_by_ig_id("test")
        )
    ...
    def test_delete_user_following_by_ig_id(self):
        delete_user_following_by_ig_id = UserFollowing.delete_user_following_by_ig_id(
            "test"
        )
