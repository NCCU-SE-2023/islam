...
class UserPostLike(Document):
    ...
    def create(raw_data):
        ...
        latest_user_post_like = UserPostLike.get_latest_user_post_like_by_ig_id(
        ...
        if latest_user_post_like is not None:
            ...
            if (
                ...
                not in latest_user_post_like.scraped_task_list
            ):
        ...
        userpost_like = UserPostLike(
            user_post_like_id=user_post_like_id,
            create_at=create_at,
            scraped_ig_id=raw_data["scraped_ig_id"],
            post_count=raw_data["post_like_count"],
            post_like_dict=raw_data["post_like_dict"],
    ...
    def get_latest_user_post_like_by_ig_id(scraped_ig_id: str):
        try:
            return (
                UserPostLike.objects(scraped_ig_id=scraped_ig_id)
                .order_by("-create_at")
                .first()
            )
